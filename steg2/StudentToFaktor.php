...
$stu_sql = "SELECT two_factor FROM student, studieretning WHERE student.id=? AND
...
$qrCodeUrl = $ga->getQRCodeGoogleUrl('Student', $secret);
...
echo '<img src="'.$qrCodeUrl.'">';
	if (!mysqli_stmt_prepare($stu_stmt, $stu_sql)) {
		...
		while($student_row = mysqli_fetch_assoc($stu_result)) {
			...
			echo'
		<form action="includes/studentTwoFactor.inc.php" method="POST" autocomplete="off">
...
?>
<a href="StudentHjemmeSide.php"><p>tilbake</p</a>
</main>
</body>
</html>
